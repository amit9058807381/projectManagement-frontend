       ...
       <Card className='rounded-md py-1 pb-2'>
         <CardHeader className='py-0 pb-1'>
            <div className="flex justify-between items-center text-gray-300">
                ...
                <DropdownMenu>
                    <DropdownMenuTrigger>
                        <Button className='rounded-full hover:bg-slate-600 text-gray-400' size="icon" variant="ghost">
                            <DotsVerticalIcon/>
                        </Button>
                    </DropdownMenuTrigger>
         ...
         <CardContent className='py-0'>
            <div className="flex items-center justify-between text-gray-400">
                ...
                <DropdownMenu className='w-[30rem] border border-red-400'>
                    <DropdownMenuTrigger>
                    <Button size="icon" variant="ghost" className=' rounded-full  hover:bg-slate-600'>
                        <Avatar>
                            <AvatarFallback>
                                <PersonIcon />
                            </AvatarFallback>
